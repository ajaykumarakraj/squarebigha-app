        ...
        <SafeAreaView style={styles.safeArea} edges={['top']}>
            <ScrollView horizontal={false} style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                <View style={styles.hero}>
                    {imageUri ? <Image source={{ uri: `https://api.squarebigha.com/${imageUri}` }} style={styles.image} /> : <View style={[styles.image, styles.imageFallback]}><Feather name="image" size={36} color="#B9945A" /></View>}
...
const styles = StyleSheet.create({
    ...
    contactBar: { flexDirection: 'row', gap: 10, paddingHorizontal: 18, paddingVertical: 12, backgroundColor: '#FFF', borderTopWidth: 1, borderTopColor: '#E3DFD6',marginBottom:30 },
